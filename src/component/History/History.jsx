                ...
                <Tab eventKey="INT Career" title="INT Career">
                  <div className="bg">
                    <div className="zin w-100 h-100 p-5">
                      ...
                      <h4>Italy U19:</h4>
                      <p>
                        Bragonzi was part of the Italian U19 national team,
                        where she made a significant impact in several
                        competitions. She has been recognized for her
                        goal-scoring abilities at this level, contributing to
                        Italy's performance in youth tournaments.
                      </p>
                      <h4>Italy U23:</h4>
                      <p>
                        Bragonzi has also progressed to the Italy U23 squad,
                        continuing her development and representing her country
                        at a higher level. Her performances in the youth ranks
                        have made her a player to watch for potential inclusion
                        in the senior squad.
                      </p>
                      <p>
                  ...
                  <div className="bg">
                    <div className="zin p-5 w-100 h-100">
                      <h4>
                        ...
                        lives away from the public eye. However, some insights
                        can be gathered:
                      </h4>
                      <p>
                        Family Support: Asia has mentioned her family's
                        influence on her football career, particularly her
                        mother, who initially had reservations about her
                        pursuing football but eventually became her biggest
                        supporter Calcio Hellas
                      </p>
                      <h4>
                        Passion for Football: She has expressed a deep passion
                        for football, emphasizing that it was the only sport she
                        wanted to pursue despite her mother's attempts to
                        introduce her to other activities Calcio Hellas
                      </h4>
                      <p>
                        Social Media Presence: Asia is active on social media,
                        where she shares glimpses of her life, training, and
                        moments with teammates. This platform often provides
                        fans with a more personal view of her experiences as a
                        player.
                      </p>
                    </div>
                  </div>
                ...
                <Tab eventKey="Club Career" title="Club Career">
                  <div className="bg">
                    <div className="zin p-5 w-100 h-100 pading">
                      ...
                      <p>
                        After Juventus, she moved to Hellas Verona, where she
                        spent a season to gain more playing time and experience.
                      </p>
                      <h4>Sassuolo (2022):</h4>
                      <p>
                      ...
                      <p>
                        ...
                        Pomigliano, continuing her progress as an effective
                        striker.
                      </p>
                      <h4>Sampdoria (2023):</h4>
                      <p>
                        Bragonzi's time at Sampdoria was highlighted by a
                        crucial goal against Juventus late in 2023.
                      </p>
